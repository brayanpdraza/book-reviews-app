        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CategoriasLibroId = table.Column<long>(type: "bigint", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Libros", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Libros_CategoriasLibro_CategoriasLibroId",
                        column: x => x.CategoriasLibroId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Libros_CategoriasLibroId",
                table: "Libros",
                column: "CategoriasLibroId");
